    ...
    <div ref={inViewRef} className={className}>
      ...
      >
        {visibleTags.map((tag, index) => (
          ...
          >
            <div
              className={`font-bold text-base sm:text-sm lg:text-[16px] ${tag.bgColor} rounded-full hover:cursor-grab px-3.5 sm:px-5 md:px-7 py-2 sm:py-2.5 md:py-3.5 border-black border-2 text-[#1E1E1E] cursor-grab`}
            >
              {tag.text}
            </div>
          </MatterBody>
