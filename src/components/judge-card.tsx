...
const JudgeCard = ({ judge }: JudgeCardProps) => {
  return (
    <aside className="space-y-3 sm:space-y-4 w-full max-w-[280px] sm:max-w-[320px] md:max-w-[350px] lg:max-w-[390px] mx-auto">
      <div
        className="relative w-full aspect-[7/8] border-[2px] sm:border-[3px] border-black rounded-none"
      ...
      >
        ...
        <div className="absolute -top-2 sm:-top-3 border-[1px] sm:border-[2px] border-[#1e1e1e] flex items-center justify-center left-1/2 transform -translate-x-1/2 z-20 w-[80px] sm:w-[110px] md:w-[120px] lg:w-[131px] h-[28px] sm:h-[38px] md:h-[42px] lg:h-[45px]">
          <div className="bg-white w-full px-2 sm:px-3 py-1 h-full flex items-center justify-center">
            <span className="text-[#1e1e1e] text-[11px] sm:text-[14px] md:text-[15px] lg:text-[16px] font-[500] capitalize">
              Judge
            </span>
          </div>
        </div>

        <div className="absolute top-[8px] sm:top-[11px] left-[8px] sm:left-[11px] right-[8px] sm:right-[11px] bottom-[8px] sm:bottom-[11px] overflow-hidden border-[2px] sm:border-[2.82px] border-[#1E1E1E]">
          <Image
            fill
            alt={judge.name}
      ...
      <div className="relative bg-white border border-black px-2 sm:px-3 md:px-4 py-1 sm:py-2 text-center">
        <div className="font-bold text-black text-[11px] sm:text-[12px] md:text-sm">
          {judge.name}
        </div>
        <div className="text-black text-[9px] sm:text-[10px] md:text-xs">
